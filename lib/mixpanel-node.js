...
var create_client = function(token, config) {
    ...
    */
    ...
    metrics.people = {
        ...
        */
        set: function(distinct_id, prop, to, ip, callback) {
            var $set = {}, data = {};
            ...
            if (typeof(prop) === 'object') {
                ...
                if(typeof to !== 'undefined' && iz.ip(to)) {
                    ip = to;
                }
            } else {
                $set[prop] = to;
            ...
            //add ip to request to display country of user in mixpanel engage console
            //https://mixpanel.com/docs/people-analytics/people-http-specification-insert-data
            if(typeof ip === 'function') {
                callback = ip;
            } else if(typeof ip !== 'undefined' && iz.ip(ip)) {
                data.$ip = ip;
            }
